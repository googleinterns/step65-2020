...
var MemoryComponentProvider = /** @class */ (function () {
    ...
    MemoryComponentProvider.prototype.loadConnection = function (cfg) {
    ...
    MemoryComponentProvider.prototype.createDatastore = function (cfg) {
...
function addDocSnapshotListener(firestoreClient, key, options, observer) {
    ...
    var internalListener = firestoreClient.listen(newQueryForPath(key.path), asyncObserver, options);
    return function () {
        asyncObserver.mute();
