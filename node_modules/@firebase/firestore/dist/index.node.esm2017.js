...
class MemoryComponentProvider {
    ...
    createSyncEngine(cfg) {
        return newSyncEngine(this.localStore, this.remoteStore, this.datastore, this.sharedClientState, cfg.initialUser, cfg.maxConcurrentLimboResolutions, 
        /* isPrimary= */ true);
    }
...
class MultiTabIndexedDbComponentProvider extends IndexedDbComponentProvider {
    ...
    createSyncEngine(cfg) {
        const startsAsPrimary = !cfg.persistenceSettings.durable ||
            !cfg.persistenceSettings.synchronizeTabs;
        const syncEngine = newSyncEngine(this.localStore, this.remoteStore, this.datastore, this.sharedClientState, cfg.initialUser, cfg.maxConcurrentLimboResolutions, startsAsPrimary);
...
function addDocSnapshotListener(firestoreClient, key, options, observer) {
    ...
    const internalListener = firestoreClient.listen(newQueryForPath(key.path), asyncObserver, options);
    return () => {
        asyncObserver.mute();
